...
= Sistema Bancário para Testes com JUnit 5 image:https://img.shields.io/github/workflow/status/Diego-VT/Sistema-Bancario---JUnit/maven[GitHub Workflow Status]
